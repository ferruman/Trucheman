...
export function DeleteJobDialog({ open, busy, onCancel, onConfirm }: Props) {
  ...
  return (
    ...
    >
      ...
      <p>
        This permanently removes the source EPUB, translation journals, and generated output. This
      ...
      <div className="actions">
        ...
        <button className="danger" disabled={busy} type="button" onClick={onConfirm}>
